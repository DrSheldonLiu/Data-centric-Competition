    ...
    def __call__(self, *args, **kwargs):
        ...
        for kk, vv in self.src_images_path_dict.items():
            ...
            if kk in ['i', 'ii', 'iii', 'x']:
                ...
                method_list = [f"augment_{i}" for i in ['add_dot_lines', 'crop', 'fliph', 'fliplr', 'invert', 'mor', 'noise', 'rotate']]
                selected_method = list(method_list)
                for each_vv in vv:
                ...
                method_list = [f"augment_{i}" for i in ['add_dot_lines', 'crop', 'iv_enrich_vi', 'invert', 'mor', 'noise', 'rotate']]
                selected_method = list(method_list)
                for each_vv in vv:
                    for mm in selected_method:
                        self.__getattribute__(mm)(each_vv)
                ...
                method_list = [f"augment_{i}" for i in ['add_dot_lines', 'crop', 'vi_enrich_iv', 'invert', 'mor', 'noise', 'rotate']]
                selected_method = list(method_list)
                for each_vv in vv:
                    for mm in selected_method:
                        self.__getattribute__(mm)(each_vv)
                ...
                method_list = [f"augment_{i}" for i in ['add_dot_lines', 'crop', 'fliplr', 'invert', 'mor', 'noise', 'rotate']]
                selected_method = list(method_list)
                for each_vv in vv:
                    for mm in selected_method:
                        self.__getattribute__(mm)(each_vv)
