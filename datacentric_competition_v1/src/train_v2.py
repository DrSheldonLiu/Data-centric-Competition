...
directory = "../data_cleaned_v2_train_val_splitted"
...
if __name__ == "__main__":
   ...
   #     lambda image, label: (tf.image.random_flip_left_right(image), label))
    ...
    if not args.eval:
        ...
        ckpt_path = f"logs_v2/ckpt/{timestamp}/checkpoint"
        ...
        ckpt_path = os.path.join('logs_v2', 'ckpt', args.timestamp, 'checkpoint')
